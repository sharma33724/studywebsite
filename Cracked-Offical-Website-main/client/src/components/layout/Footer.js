        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Your premier destination for SAT preparation. We help students achieve their academic goals with comprehensive study materials, practice tests, and personalized learning paths.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-600">
                ...
                <span className="text-sm">support@crackdofficial.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-600">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-sm text-gray-600">
              © {currentYear} Crackd Official. All rights reserved.
            </div>
